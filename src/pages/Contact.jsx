...
const contactSchema = yup.object().shape({
  ...
  location: yup.string().required("Location is require"),
  phone: yup
    .string()
      ...
      <div className="container mx-auto py-12 sm:py-24">
        ...
        >
          <h2 className="text-4xl font-bold text-gray-800 dark:text-white mb-4">
            Send Us Your <span className="text-primary">Requirement</span>
          </h2>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 space-y-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <p className="text-gray-700 dark:text-gray-300 text-md ">
                  601 Shivalik Satyamev, Ahmedabad, India
                </p>
              </div>
            </div>
