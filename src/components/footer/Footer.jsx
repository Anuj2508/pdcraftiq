        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-14 md:gap-4">
          ...
          <div className="space-y-4 max-w-[300px]">
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">
              <span className="text-primary">Premium Signage Services</span>
            </h1>
            <p className="text-dark2 dark:text-gray-400 text-md sm:text-lg">
              We offer high-quality signage and branding solutions to help
              businesses stand out and attract more customers. Fast, reliable,
              and hassle-free.
            </p>
          </div>
